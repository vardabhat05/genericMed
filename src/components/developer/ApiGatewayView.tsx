...
export const ApiGatewayView: React.FC = () => {
  ...
  const handleRunApiTest = () => {
    ...
    setTimeout(() => {
      setApiLoading(false);
      setResponseTimeMs(18); // 18ms

      if (selectedEndpoint === '/v1/medicines/bioequivalent-search') {
        setApiResponse({
          status: "success",
          canonical_salt: "Metformin Hydrochloride (CAS: 1115-70-4)",
          brand_query: "Glucophage XR",
          reference_innovator_price_usd: 23.00,
          recommended_generics: [
            {
              generic_name: "Glycomet 500mg ER",
              manufacturer: "USV Private Ltd",
              bioequivalence_score_pct: 99.4,
              f2_similarity_metric: 78.4,
              fda_rating: "AB-Rated Equivalent",
              price_usd: 4.80,
              savings_pct: 79.13,
              in_stock_local_hubs: 142
            },
            {
              generic_name: "Metformin ER 500mg",
              manufacturer: "Aurobindo Pharma",
              bioequivalence_score_pct: 98.9,
              f2_similarity_metric: 76.1,
              fda_rating: "AB-Rated Equivalent",
              price_usd: 4.50,
              savings_pct: 80.43,
              in_stock_local_hubs: 110
            }
          ],
          telemetry: {
            cache_hit: true,
      ...
      } else if (selectedEndpoint === '/v1/orders/escrow/pre-authorize') {
        setApiResponse({
          status: "escrow_hold_active",
          escrow_id: "ESC-904128",
          authorized_amount_usd: 13.94,
  ...
  const handleEmitTestKafkaEvent = () => {
